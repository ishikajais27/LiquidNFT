  ...
  useEffect(() => {
    ...
    class Simulation {
      ...
      update() {
        ...
        if (this.options.isViscous) { vel = this.viscous_pass.update({ viscous: this.options.viscous, iterations: this.options.iterations_viscous, dt: this.options.dt }); }
